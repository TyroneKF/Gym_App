...
import App_Code.Objects.Screens.Add_Ingredients_Screen.Add_Ingredients_Screen3;
import App_Code.Objects.Screens.MacrosTargets_Screen.macrosTargets_Screen3;
...
public class MealPlanScreen3 extends JPanel
{
    ...
    private MyJDBC db;
    private macrosTargets_Screen3 macrosTargets_Screen = null;
    private Add_Ingredients_Screen3 Add_Ingredients_Screen3 = null;
    ...
    public void open_AddIngredients_Screen()
    {
        ...
        if (Add_Ingredients_Screen3!=null)
        {
            Add_Ingredients_Screen3.makeJframeVisible();
            return;
        }
        Add_Ingredients_Screen3 = new Add_Ingredients_Screen3(db, this, planID, tempPlanID, planName);
    }

    public void remove_addIngredients_Screen()
    {
        Add_Ingredients_Screen3 = null;
    }
    ...
    public void open_MacrosTagets_Screen()
    {
        ...
        macrosTargets_Screen = new macrosTargets_Screen3(db, this, planID, tempPlanID, planName);
    }
