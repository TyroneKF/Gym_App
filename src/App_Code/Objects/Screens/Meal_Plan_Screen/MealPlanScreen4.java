...
import App_Code.Objects.Screens.Add_Ingredients_Screen.Add_Ingredients_Screen4;
import App_Code.Objects.Screens.MacrosTargets_Screen.macrosTargets_Screen4;
...
public class MealPlanScreen4 extends JPanel
{
    ...
    private MyJDBC db;
    private macrosTargets_Screen4 macrosTargets_Screen = null;
    private Add_Ingredients_Screen4 Add_Ingredients_Screen4 = null;
    ...
    public void open_AddIngredients_Screen()
    {
        ...
        if (Add_Ingredients_Screen4!=null)
        {
            Add_Ingredients_Screen4.makeJframeVisible();
            return;
        }
        Add_Ingredients_Screen4 = new Add_Ingredients_Screen4(db, this, planID, tempPlanID, planName);
    }

    public void remove_addIngredients_Screen()
    {
        Add_Ingredients_Screen4 = null;
    }
    ...
    public void open_MacrosTagets_Screen()
    {
        ...
        macrosTargets_Screen = new macrosTargets_Screen4(db, this, planID, tempPlanID, planName);
    }
