...
import App_Code.Objects.Screens.MacrosTargets_Screen.macrosTargets_Screen2;
...
public class MealPlanScreen2 extends JPanel
{
    ...
    private MyJDBC db;
    private macrosTargets_Screen2 macrosTargets_Screen = null;
    ...
    public void open_MacrosTagets_Screen()
    {
        ...
        macrosTargets_Screen = new macrosTargets_Screen2(db, this, planID, tempPlanID, planName);
    }
