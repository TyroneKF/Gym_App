...
public class macrosTargets_Screen4 extends JFrame
{
    private MyJDBC db;
    ...
    public macrosTargets_Screen4(MyJDBC db, MealPlanScreen4 gui, int planID, int temp_PlanID, String planName)
    {
        this.db = db;
        this.gui = gui;
