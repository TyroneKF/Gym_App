...
public class macrosTargets_Screen2 extends JFrame
{
    private MyJDBC db;
    ...
    public macrosTargets_Screen2(MyJDBC db, MealPlanScreen2 gui, int planID, int temp_PlanID, String planName)
    {
        this.db = db;
        this.gui = gui;
