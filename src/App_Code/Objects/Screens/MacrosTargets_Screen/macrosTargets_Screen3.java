...
public class macrosTargets_Screen3 extends JFrame
{
    private MyJDBC db;
    ...
    public macrosTargets_Screen3(MyJDBC db, MealPlanScreen3 gui, int planID, int temp_PlanID, String planName)
    {
        this.db = db;
        this.gui = gui;
