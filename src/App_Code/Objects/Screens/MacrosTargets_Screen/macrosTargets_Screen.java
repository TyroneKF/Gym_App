package App_Code.Objects.Screens.MacrosTargets_Screen;

import App_Code.Objects.Database_Objects.JDBC.MyJDBC;
import App_Code.Objects.Gui_Objects.JTextFieldLimit;
import App_Code.Objects.Screens.Meal_Plan_Screen.MealPlanScreen1;
...
public class macrosTargets_Screen extends JFrame
{
    ...
    public macrosTargets_Screen(MyJDBC db, MealPlanScreen1 gui, int planID, int temp_PlanID, String planName)
    {
        this.db = db;
        this.gui = gui;
    ...
    public boolean updateForm()
    {
      String updateTargets_Query = String.format("""
              ...
              WHERE PlanID =  1;""", listOfTextFields.get(1).getText().trim(), listOfTextFields.get(2).getText().trim(),listOfTextFields.get(3).getText().trim(),
