...
public class MyJTable_JDBC5 extends JDBC_JTable
{
    //####################################
    // Objects
    //####################################
    ...
    private MyJTable_JDBC5 total_Meal_Table, macrosLeft_Table, ingredientsTableCalculation;
    ...
    public MyJTable_JDBC5(MyJDBC db, Container parentContainer, String databaseName, String tableName,
    ...
    // Total Plan Table
    public MyJTable_JDBC5(MyJDBC db, Container parentContainer, Object[][] data, String[] columnNames, int planID,
    ...
    // Total Meal Table
    public MyJTable_JDBC5(MyJDBC db, CollapsibleJPanel collapsibleObj, String databaseName, Object[][] data, String[] columnNames, int planID,
    ...
    public MyJTable_JDBC5(MyJDBC db, CollapsibleJPanel collapsibleObj, String databaseName, Object[][] data, String[] columnNames, int planID,
                          ...
                          ArrayList<Integer> unEditableColumns, ArrayList<Integer> colAvoidCentering, boolean setIconsUp,
                          MyJTable_JDBC5 total_Meal_Table, MyJTable_JDBC5 macrosLeft_Table)
    {
        super.db = db;
