...
public class JTbable_JButton2 extends JFrame
{
    private JTable table;
    private JScrollPane scrollPane;

    public JTbable_JButton2()
    {
        setTitle("JTableButton Test");
        TableCellRenderer tableRenderer;
        table = new JTable(new JTableButtonModel2());
        tableRenderer = table.getDefaultRenderer(JButton.class);
        table.setDefaultRenderer(JButton.class, new JTableButtonRenderer2(tableRenderer));
