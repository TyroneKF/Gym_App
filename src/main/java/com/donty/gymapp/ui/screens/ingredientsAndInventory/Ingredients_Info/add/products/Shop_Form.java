...
public class Shop_Form extends Parent_Forms_OBJ
{
    ...
    public void add_Update_Queries(Batch_Upload_Statements upload_statements) throws Exception
    {
        ...
        int input_Params_Per_Item = 5; // Ingredient ID isn't a field inputted by the user

        //######################
        // Create Params Query
        //######################
        StringBuilder insert_Header = new StringBuilder("""
    ...
    {
        return ingredient_Screen.get_Ingredients_Name();
    }
}