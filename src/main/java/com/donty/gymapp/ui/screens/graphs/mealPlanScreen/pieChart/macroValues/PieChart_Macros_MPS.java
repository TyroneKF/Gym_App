...
public class PieChart_Macros_MPS extends Screen_JPanel
{
    ...
    private final LinkedHashMap<Draft_Gui_Total_Meal_Macro_Columns, DefaultPieDataset<PieChart_MacroKey>> macroValue_Dataset_Map = new LinkedHashMap<>();

    private final LinkedHashMap<Draft_Gui_Total_Meal_Macro_Columns, String> total_meal_macro_symbol;
    ...
    private DefaultPieDataset<PieChart_MacroKey> create_Macro_PieChart_Dataset(Draft_Gui_Total_Meal_Macro_Columns macro_name)
    {
        ...
        */
        ...
        return macroDataset; // Return Values
    }
    ...
    private Color[] generate_Random_Palette_Order()
    {
        ...
        for (int i = 0; i < colorSize; i++) // Generate x amount of colors to match meals count
        {
