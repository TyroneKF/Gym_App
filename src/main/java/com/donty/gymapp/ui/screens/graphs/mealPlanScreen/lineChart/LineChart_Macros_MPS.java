package com.donty.gymapp.ui.screens.graphs.mealPlanScreen.lineChart;
...
class LineChart_Macros_MPS extends Screen_JPanel
{
    ...
    )
    {
        ...
        add_To_Container(get_ScrollPane_JPanel(), line_chart, 0, get_And_Increase_YPos(), 0.25, "both", 0, 0);
    }
