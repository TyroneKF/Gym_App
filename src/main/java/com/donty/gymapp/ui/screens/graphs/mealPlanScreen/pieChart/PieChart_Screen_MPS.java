package com.donty.gymapp.ui.screens.graphs.mealPlanScreen.pieChart;
...
import com.donty.gymapp.ui.screens.graphs.mealPlanScreen.pieChart.macroValues.PieChart_Macros_MPS;
import com.donty.gymapp.ui.screens.graphs.mealPlanScreen.pieChart.totalMeals.PieChart_Totals_Entry_MPS;
import com.donty.gymapp.ui.screens.graphs.mealPlanScreen.pieChart.totalMeals.PieChart_TotalMeals_MPS;
...
public class PieChart_Screen_MPS extends Screen_JFrame
{
    ...
    public void refresh()
    {
        pieChart_TotalMeals_MPS.create_And_Draw_GUI(); // TotalMeal PieChart MPS
    ...
    public void clear()
    {
        pieChart_TotalMeals_MPS.clear(); // TotalMeal PieChart MPS
    ...
    {
        pieChart_TotalMeals_MPS.add_MealManager_To_GUI(mealManager); // TotalMeal PieChart MPS
    ...
    {
        pieChart_TotalMeals_MPS.delete_MealManager(mealManager);   // TotalMeal PieChart MPS
