...
(1, 4, 4,  51, 28), -- Sugar
(1, 5, 5,  40, 140), -- Milk
(1, 6, 6,  45, 110), -- Yoghurt


-- # Breakfast Part 2 (Eggs + Plantain)
(2, 7, 7,   44, 3), -- EGGS
(2, 8, 8,   40, 40), -- Milk
(2, 9, 9,   50, 120), -- Plantain

-- # Breakfast Part 3 (Celery Drink)
(3, 10, 10,  11, 110), -- Celery
(3, 11, 11,  2, 500), -- Water
...
-- # Oatmeal Part 4
(4, 12, 12,  26, 110), -- Oatmeal
(4, 13, 13,  28, 35), -- Nut Powder
(4, 14, 14,  40, 450), -- Milk
(4, 15, 15, 27, 16), -- Honey

-- # Bananas Part 5 
(5, 16, 16,  3, 200 ), -- Bananas

-- # Mango & Pineapple Smoothie Part 6 
(6, 17, 17,  12, 110), -- Mango
(6, 18, 18,  13, 110), -- Pineapple
(6, 19, 19,  2,  500), -- Water
...
-- # Lunch  Part 7
(7, 20, 20,  4, 2),    -- Wraps
(7, 21, 21,  22, 150), -- Chicken Mince
(7, 22, 22,  6,60),    -- BBQ Sauce


-- # Nuts  Part 8
(8, 23, 23,  19, 7),  -- Sunflower Seeeds
(8, 24, 24,  18, 7),  -- Pumpkin Seeds
(8, 25, 25,  20, 12), -- Pistachios

-- # Multivitamin Shake Part 9 
(9, 26, 26,  24 , 5), -- Maca
(9, 27, 27,  25, 30), -- Vivo Life
(9, 28, 28,  2, 500), -- Water
...
(10, 29, 29,  17, 60),  -- Raspberry
(10, 30, 30,  16, 60),  -- Blueberries
(10, 31, 31,  15, 60),  -- Strawberry
(10, 32, 32,  42, 110), -- Grapefruit
(10, 33, 33,  14, 110), -- Oranges 
(10, 34, 34,  2, 1000), -- Water
...
-- # Bananas Part 11
(11, 35, 35,  3, 200 ), -- Bananas

-- # Protein Shake Part 12
(12, 36, 36,  35, 35), -- Protein Powder
(12, 37, 37,  33, 5),  -- Creatine
(12, 38, 38,  40, 2),   -- Milk

-- # Veg Meal Part 13
(13, 39, 39,  10, 110),  -- Broccoli
(13, 40, 40,  9,  110 ), -- Carrots
(13, 41, 41,  8,  110 ), -- Sweet Potatoe
(13, 42, 42,  7, 110 ), -- Kale
...
-- # Pasta Meal Part 14
(14, 43, 43,  38, 60),    -- Dolmio Sauce
(14, 44, 44,  38, 75),  --  Pasta
(14, 45, 45,  23, 150), --  Turkey Mince
(14, 46, 46,  39, 60),  --  Sweetcorn
